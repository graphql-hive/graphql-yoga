...
[`graphql-helix` fastify example](https://github.com/graphql-hive/graphql-yoga/tree/main/examples/envelop/graphql-helix),
...
[`graphql-helix-auth0` fastify example](https://github.com/graphql-hive/graphql-yoga/tree/main/examples/envelop/graphql-helix-auth0).
...
[Envelop examples](https://github.com/graphql-hive/graphql-yoga/tree/main/examples/envelop/graphql-helix).
