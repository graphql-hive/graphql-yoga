...
https://github.com/graphql-hive/graphql-yoga/blob/main/packages/envelop/types/src/plugin.ts
...
[`@envelop/preload-assets` plugin](https://github.com/graphql-hive/graphql-yoga/tree/main/packages/envelop/plugins/preload-assets)
