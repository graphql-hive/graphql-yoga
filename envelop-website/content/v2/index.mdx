...
title: Introduction
description:
  Envelop is a lightweight library for customizing the GraphQL execution layer with composable,
  shareable plugins that work with any GraphQL server framework or schema.
---
