...
```graphql title="Example: GraphQL Query Operation"
...
```json title="Example: GraphQL Variables"
{
  "id": "1"
}
```
...
```json title="Example: GraphQL Execution Result"
{
  "data": {
    "user": {
      "__typename": "User",
...
```json title="Example: Normalized GraphQL Client Cache"
{
  "User:1": {
    "__typename": "User",
    "id": "1",
...
```graphql title="Example: GraphQL Mutation"
...
```json title="Example: GraphQL Mutation Execution Result"
{
  "data": {
    "repositoryAdd": {
      "user": {
