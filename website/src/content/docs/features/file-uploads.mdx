...
You can also write the file to disk using the standard WHATWG Streams API (works on every runtime):

```ts
// Inside your resolver — no Node.js-specific imports needed:
