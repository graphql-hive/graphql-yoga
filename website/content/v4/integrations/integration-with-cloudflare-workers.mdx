...
> [here](https://github.com/dotansimha/graphql-yoga/tree/main/examples/service-worker)

## Example with Modules Approach

```ts title="modules.mjs"
import { createSchema, createYoga } from 'graphql-yoga'
...
> You can also check a full example on our GitHub repository
> [here](https://github.com/dotansimha/graphql-yoga/tree/main/examples/cloudflare-modules)
