---
description:
  Configure CORS in GraphQL Yoga. CORS stands for Cross Origin Resource Sharing. In a nutshell, as a
  security measure, browsers aren't allowed to access resources outside their own domain.
title: CORS
---
