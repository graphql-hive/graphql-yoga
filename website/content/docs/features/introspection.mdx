---
description:
  Learn how to disable GraphQL Yoga schema introspection and the "did you mean x" suggestion
  feature.
title: Introspection
---
...
```ts title="Disabling the 'did you mean x' suggestion feature with a plugin" {2, 7}
import { createYoga } from 'graphql-yoga'
