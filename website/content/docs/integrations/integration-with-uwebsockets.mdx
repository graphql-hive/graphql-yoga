---
description: Integrate GraphQL Yoga with µWebSockets.js, an HTTP/WebSocket server for Node.js.
title: Integration with µWebSockets.js
sidebarTitle: µWebSockets.js
---
