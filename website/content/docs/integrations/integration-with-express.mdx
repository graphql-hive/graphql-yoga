---
description:
  Integrate GraphQL Yoga with Express, the most popular web framework for Node.js, a minimalist
  framework with a robust set of features to handle HTTP on Node.js applications.
