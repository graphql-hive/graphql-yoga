...
> [here](https://github.com/dotansimha/graphql-yoga/tree/v3/examples/service-worker)
...
> You can also check a full example on our GitHub repository
> [here](https://github.com/dotansimha/graphql-yoga/tree/v3/examples/cloudflare-modules)
