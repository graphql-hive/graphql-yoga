...
title: Integration with uWebSockets
sidebarTitle: µWebSockets
---

uWebSockets or [µWebSockets.js](https://github.com/uNetworking/uWebSockets.js) is an HTTP/WebSocket
server for Node.js.
