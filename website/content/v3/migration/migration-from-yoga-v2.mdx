...
[helper function `createSchema`](/v3#schema) to supplement this process.
...
context. Read more about the [new health check](/v3/features/health-check).
...
Checkout
[envelop docs](https://www.the-guild.dev/graphql/envelop/v3/guides/migrating-from-v2-to-v3#8-update-options-for-usemaskederrors-plugin)
for more details.
