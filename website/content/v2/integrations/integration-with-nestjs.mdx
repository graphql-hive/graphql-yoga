...
[NestJS](https://nestjs.com) is a progressive Node.js framework for building efficient, reliable and
...
A complete example
[is available in the repository](https://github.com/dotansimha/graphql-yoga/tree/main/examples/nestjs-apollo-federation-compatibility).
