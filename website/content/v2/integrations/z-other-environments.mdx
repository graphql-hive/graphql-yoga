---
description:
  GraphQL Yoga understands WHATWG `Request` object to consume your HTTP request. So you need an
  adapter implementation between your environment and WHATWG standard objects.
...
[WHATWG `Request` object](https://developer.mozilla.org/en-US/docs/Web/API/Request) to consume your
HTTP request. So you need an adapter implementation between your environment and WHATWG standard
objects.
