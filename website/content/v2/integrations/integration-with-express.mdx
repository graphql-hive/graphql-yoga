---
description:
  Expressis the most popular web framework for Node.js. It is a minimalist framework that provides a
  robust set of features to handle HTTP on Node.js applications.
