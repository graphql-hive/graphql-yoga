---
description:
  Migrate from Apollo Server to GraphQL Yoga. Learn how to migrate from Apollo Server to GraphQL
  Yoga.
...
plugins. Learn more about envelop plugins [here](/v2/features/envelop-plugins).
...
```diff title="apollo-server-errors-example.ts"
...
[Express Integration section](/v2/integrations/integration-with-express):
