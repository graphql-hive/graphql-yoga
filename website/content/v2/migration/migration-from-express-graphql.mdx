---
description:
  GraphQL Yoga is a fully-featured GraphQL Server with focus on easy setup, performance & great
...
<Callout>
  ...
  [@envelop/use-lazy-loaded-schema](https://envelop.dev/plugins/use-lazy-loaded-schema) for the same
  behavior.
</Callout>
