---
description:
  Learn how to use GraphQL Yoga with Apollo Federation. GraphQL Yoga is a fully-featured GraphQL
  Server with focus on easy setup, performance & great developer experience.
...
```sh npm2yarn
npm i @graphql-yoga/node @apollo/gateway @envelop/apollo-federation graphql@15
```
...
```sh npm2yarn
npm i @graphql-yoga/node @apollo/subgraph graphql
```
...
Check our
[working example](https://github.com/dotansimha/graphql-yoga/tree/v2/examples/apollo-federation) to
try it out.
