---
description:
  GraphQL Yoga supports GraphQL Multipart Request Specification which allows you to upload files via
  HTTP and consume the binary data inside GraphQL Resolvers.
title: File Uploads
---
...
```ts title="file-upload-example.ts"
...
```ts title="nexus-file-upload-example.ts"
