...
<Callout type="warning">
  Be aware that this does not make your GraphQL server more secure. As long as the introspection
  and/or the "did you mean x" suggestion feature of GraphQL are enabled.
</Callout>
...
Disabling the "did you mean x" suggestion feature is not possible at the moment
([see the corresponding graphql-js GitHub issue](https://github.com/graphql/graphql-js/issues/2247)).
...
plugin
[`@envelop/persisted-operations`](https://www.npmjs.com/package/@envelop/persisted-operations) that
